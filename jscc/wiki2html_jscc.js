vJSCC_DB['ClassList']['Wiki2HTML'] = {
    ...
    "JSCC_mod_date": "2018/01/21 17:34:25",
    ...
    "tAttribDefault": "",
    "sAttribTypeList": "",
    "tMethodHeader": "replaceString(pString:String,pSearch:String,pReplace:String):String",
    "tMethodName": "",
    "tMethodComment": "replaceString(pString,pSearch,pReplace) replaces globally pSearch by pReplace and returns the modified string",
    "sMethodList": "replaceString",
    "tMethodCode": "\t//alert(\"cstring.js - replaceString() \"+pString);\n\tif (!pString) {\n\t\talert(\"replaceString()-Call - pString not defined!\");\n\t} else if (pString != '') {\n  \t    //alert(\"cstring.js - replaceString() \"+pString);\n  \t\tvar vHelpString = '';\n        var vN = pString.indexOf(pSearch);\n  \t\tvar vReturnString = '';\n  \t\twhile (vN >= 0) {\n  \t\t\tif (vN > 0)\n  \t\t\t\tvReturnString += pString.substring(0, vN);\n  \t\t\t    vReturnString += pReplace;\n                if (vN + pSearch.length < pString.length) {\n  \t\t\t\t    pString = pString.substring(vN+pSearch.length, pString.length);\n  \t\t\t    } else {\n  \t\t\t\t    pString = ''\n  \t\t\t    };\n  \t\t\t    vN = pString.indexOf(pSearch);\n  \t\t    };\n  \t    };\n  \t    return vReturnString + pString;\n  \t}",
    "tLoopObject": "",
    "tLoopMethod": "",
    "AttribType": {
        "aProjectDir": "String",
